...
public partial class CiPlatformDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA4141AA8AC02E");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C340AAE49D1");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A89C34217C");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52A774EFD0");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E795768757B9B537");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055195E0B99");
        ...
        {
            entity.HasKey(e => e.FavoriteMissionId).HasName("PK__favorite__B4CF3312205A84C1");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C77A01DFB6");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB26640C94A");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A71CA5EDC");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC8F02CB89C");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED1581D7AFDCE");
        ...
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E873B72F19");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E5172E4DE2F3E");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008FEA39D95");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5AC4B1F247D");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA83791CE7635C");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C561394C383");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867B64CCA90");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053CDA8BEE75");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF5068CE82583E");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F6D3973BF");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576B2F78B056");
